...
__webpack_require__.d(__webpack_exports__, {
  getUserStatus: () => (/* reexport */ getUserStatus),
...
;// CONCATENATED MODULE: ./src/tests/user/getUserStatus.ts
...
var funcExecution = ['getUserStatus'];
...
var threshold = Object.assign({}, k6exec.generateCustomThreshold('http_req_duration{ scenario: getUserStatus }', 'avg<=23904'), k6exec.generateCustomThreshold('http_req_failed{ scenario: getUserStatus }', 'rate<=0.03'));
var options = {
  scenarios: scenarios,
