...
__webpack_require__.d(__webpack_exports__, {
  getUserInfo: () => (/* reexport */ getUserInfo),
...
;// CONCATENATED MODULE: ./src/tests/user/getUserInfo.ts
...
var threshold = Object.assign({}, k6exec.generateCustomThreshold('http_req_duration{ scenario: getUserInfo }', 'avg<=23904'), k6exec.generateCustomThreshold('http_req_failed{ scenario: getUserInfo }', 'rate<=0.03'));
var options = {
  scenarios: scenarios,
