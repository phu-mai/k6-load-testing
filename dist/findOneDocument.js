...
__webpack_require__.d(__webpack_exports__, {
  findDocument: () => (/* reexport */ findDocument),
...
;// CONCATENATED MODULE: ./src/tests/mongoDB/findOneDocument.ts


var k6exec = new k6Executor();
var funcExecution = ['findDocument'];
...
var threshold = Object.assign({}, k6exec.generateCustomThreshold('http_req_duration{ scenario: findDocument }', 'avg<=23904'), k6exec.generateCustomThreshold('http_req_failed{ scenario: findDocument }', 'rate<=0.03'));
var options = {
  scenarios: scenarios,
...
/******/ })()
;
//# sourceMappingURL=findOneDocument.js.map